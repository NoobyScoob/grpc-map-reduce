...
type MapperServiceClient interface {
	RunMap(ctx context.Context, in *RunMapInput, opts ...grpc.CallOption) (*empty.Empty, error)
	InitReduce(ctx context.Context, in *InitReduceInput, opts ...grpc.CallOption) (*empty.Empty, error)
}
...
func (c *mapperServiceClient) RunMap(ctx context.Context, in *RunMapInput, opts ...grpc.CallOption) (*empty.Empty, error) {
	out := new(empty.Empty)
...
func (c *mapperServiceClient) InitReduce(ctx context.Context, in *InitReduceInput, opts ...grpc.CallOption) (*empty.Empty, error) {
	out := new(empty.Empty)
...
type MapperServiceServer interface {
	RunMap(context.Context, *RunMapInput) (*empty.Empty, error)
	InitReduce(context.Context, *InitReduceInput) (*empty.Empty, error)
...
func (UnimplementedMapperServiceServer) RunMap(context.Context, *RunMapInput) (*empty.Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method RunMap not implemented")
}
func (UnimplementedMapperServiceServer) InitReduce(context.Context, *InitReduceInput) (*empty.Empty, error) {
